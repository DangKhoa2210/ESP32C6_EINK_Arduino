...
GxIO_Class io(SPI, /*CS=19*/ 19, /*DC=*/ 21, /*RST=*/ 16); // arbitrary selection of 17, 16
GxEPD_Class display(io, /*RST=*/ 16, /*BUSY=*/ 1); // arbitrary selection of (16), 4
...
void loop()
{
  ...
  showFont("Anh Y dep trai", &FreeMonoBold12pt7b);
#endif
